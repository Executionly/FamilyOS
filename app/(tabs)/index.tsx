...
import {
  ScrollView, Text, View, Pressable, TouchableOpacity,
...
export default function HomeScreen() {
  ...
  const nextMeeting = meetings.find((m) => new Date(m.scheduled_date) > now);
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 4 }}>
              ...
              <TouchableOpacity
                ...
                style={{ backgroundColor: 'rgba(255,255,255,0.18)', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 6 }}
              >
